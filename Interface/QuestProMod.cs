...
namespace QuestProModule
{
    public class QuestProMod : ResoniteMod
    {
		...
		public override void OnEngineInit()
		{
			...
			Engine.Current.RunPostInit(() =>
			{
				try
				{
					...
					Engine.Current.InputInterface.RegisterInputDriver(edm);
					Engine.Current.InputInterface.RegisterInputDriver(mdm);
				}
				catch (Exception ex)
				{
        ...
        {
            if (@event.Label == "ModSettings variable change") return;
